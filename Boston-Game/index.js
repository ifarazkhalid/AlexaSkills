...
const languageString = {
  en: {
    translation: {
      ...
      WELCOME_MESSAGE: 'Hello Kevin, Rens, Barry and Faraz. I will ask you %s questions, try to get as many right as you can. Just say the number of the answer. For example, if you think the answer to the first question might be one, say something like, "I think it is one." That might be a hint, who knows. Let\'s begin. ',
      ANSWER_CORRECT_MESSAGE: 'correct. Good job! ',
      ANSWER_WRONG_MESSAGE: 'wrong. ',
      CORRECT_ANSWER_MESSAGE: 'The correct answer is %s: %s. ',
      ANSWER_IS_MESSAGE: 'That answer is ',
      TELL_QUESTION_MESSAGE: 'Question %s. %s ',
      GAME_OVER_MESSAGE: 'You got %s out of %s questions correct. Thank you for playing! Bye bye!',
  ...
  'en-US': {
    translation: {
      QUESTIONS: questions.QUESTIONS_EN_US,
      GAME_NAME: 'Questions about Boston'
    },
  },
};
